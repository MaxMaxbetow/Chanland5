...
export default function Header() {
  ...
  return (
    <div className={`fixed z-50 w-full flex justify-center transition-all duration-700 ease-[cubic-bezier(0.4,0,0.2,1)] ${isScrolled ? 'top-4 px-4' : 'top-0 px-0'}`}>
      <header 
        className={`transition-all duration-700 ease-[cubic-bezier(0.4,0,0.2,1)] ${
          isScrolled 
            ? 'w-full max-w-5xl rounded-full bg-white/70 backdrop-blur-2xl border border-white/60 shadow-lg' 
