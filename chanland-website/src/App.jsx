...
function Header() {
  ...
  const blur = isScrolled ? "blur(20px)" : "blur(12px)";
    ...
    <div className={`fixed z-50 w-full flex justify-center header-outer ${isScrolled ? "top-4 px-4" : "top-0 px-0"} transition-all duration-300`}>
      ...
      >
        ...
        >
          ...
          {menuOpen && (
            <div className="lg:hidden absolute top-full left-4 right-4 mt-2 bg-white/60 backdrop-blur-2xl rounded-3xl border border-white/50 shadow-xl p-6 space-y-3 animate-fade-in-up">
              {navLinks.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
              ...
              <div className="pt-2 border-t border-white/30">
                ...
                {downloadOpen && (
                  <div className="overflow-hidden pl-4 space-y-2 mt-2 animate-fade-in-up">
