...
function Header() {
  ...
  return (
    <div
      className={`fixed z-50 w-full flex justify-center transition-all duration-500 ease-out ${
        isScrolled ? "top-4 px-4" : "top-0 px-0"
      }`}
    >
      <header
        className={`${mounted ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-5"} 
      ...
      >
        <div className="mx-auto px-4 sm:px-6 py-3 flex justify-between items-center">
          <a href="#" className="flex items-center gap-3 shrink-0">
            ...
            />
            <span className="text-xl font-bold text-slate-800 tracking-wide hidden sm:block">
              ChanLand
            </span>
          </a>
        ...
        {menuOpen && (
          <div
            className="lg:hidden absolute top-full left-4 right-4 mt-2 bg-white/60 backdrop-blur-2xl rounded-3xl border border-white/50 shadow-xl p-6 space-y-3 
          ...
          >
            ...
            <div className="pt-2 border-t border-white/30">
              ...
              {downloadOpen && (
                <div className="overflow-hidden pl-4 space-y-2 mt-2 animate-[fadeIn_0.25s_ease-out]">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block px-4 py-2 text-slate-500 hover:text-slate-800 text-sm rounded-lg hover:bg-white/40 transition-all"
                  >
                    Сборка сезон 4
                  </a>
                  <a
